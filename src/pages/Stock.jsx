...
export default function Stock() {
  ...
  return <div className="p-6 max-w-7xl mx-auto space-y-6">
    ...
    {tab === "batches" && <Panel title="Stock Batches"><Table headers={["Batch", "Supplier", "Arrival", "Kg", "FCA", "Transport", "Vehicle", "Total landed", "€/kg", "Status"]} rows={batches.map((b) => [b.batch_ref, b.supplier, b.arrival_date, num(b.total_kg_received).toFixed(1), money(b.supplier_fca_total), money(num(b.transport_to_girona) + num(b.transport_to_nl)), money(b.vehicle_cost), money(b.total_landed_cost), money(b.landed_cost_per_kg), b.status])} /></Panel>}
