...
const F = {
  ...
  BankTransaction: ["import_batch_id","accounting_month","month","date","code","type","reference","payment_ref","counterparty","status","amount_out","amount_in","fees","balance","category","cost_type","channel","event_id","event_name","review_status","counted_expense","shipping_cost","operating_expenses","car_rental_nl","transport_spain_to_amsterdam","event_cost","meat_purchase","refund_amount","expense_refund_amount","is_active"],
};
