...
export const IMPORT_CONFIGS = {
  sumup_sales: {
    ...
    targetFields: [
      ...
      { key: "product", label: "Description / Product", required: true },
    ...
    dateField: "date",
    requiredFields: ["date", "product", "gross_inc_vat"],
  ...
  bank_transactions: {
    ...
    targetFields: [
      { key: "date", label: "Date", required: true },
      { key: "counterparty", label: "Counterparty / Name" }, // optional — falls back to referentie or "Unknown"
      ...
      { key: "amount", label: "Amount (single column with sign)" },
