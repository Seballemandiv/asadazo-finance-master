...
import { Calendar, Package, TrendingDown, TrendingUp, ShoppingBag, Plus, Trash2 } from "lucide-react";
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div><h1 className="text-2xl font-bold text-foreground">Event Calendar</h1><p className="text-muted-foreground text-sm mt-1">Asadazo · Events, tasks and event P&L</p></div>
